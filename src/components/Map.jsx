    ...
    <div className="w-full mt-10">
      <div className="grid grid-cols-1 md:grid-cols-2">
        <div className="pr-0 md:pr-2">
          ...
          <p className="pb-5 pr-5 md:pr-2">
            Experience the ultimate in automotive care with our Mobile Car
            Detailing service. Say goodbye to time-consuming trips to the car
            wash – our skilled auto detailing technicians bring their expertise
            right to your doorstep. Life's demands can be overwhelming, but
            ...
            disrupting your day. Whether you're at home, the office, or anywhere
            in between, our team guarantees a comprehensive and eco-friendly
            detailing experience tailored to your needs. Get your car spotless
            and shining without lifting a finger!
          </p>
        </div>
        <div>
