...
const PromoItem = ({ title, image, description }) => {
  return (
    <div className="h-48 w-full mx-auto relative">
      <div className="mx-auto z-10 px-4 py-2 grid grid-cols-1 h-full absolute">
        ...
        <p className="text-white drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)] p-1 font-poppins font-normal text-xl md:text-2xl self-start">
          {description}
        </p>
      </div>
      <div>
