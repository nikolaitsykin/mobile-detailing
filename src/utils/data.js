...
export const basicExteriorServices = [
  "✔ Pre-Cleaning in Multiple Steps",
  "✔ Hand Washing with Proper PH Soap",
  "✔ Door Frame Cleaning",
...
export const basicInteriorServices = [
  ...
  "✔ Vacuuming w/ Agitation All Areas",
  "✔ Surface Cleaning w/ APC",
  "✔ Floor Mats Cleaned",
  "✔ Glass Cleaning",
  "✔ Air Freshener",
  "✔ Plastic Dressing",
  "✘ Deep Hot Water Shampoo",
  "✘ Steam Cleaning Plastic, Glass, Leather",
  "✘ Leather Protection & Conditioner",
...
export const basicPackage = {
  ...
  exteriorImage: basicExteriorWashImage,
  interiorImage: basicInteriorWashImage,
  exteriorServices: basicExteriorServices,
  interiorServices: basicInteriorServices,
  price:
    "Small Cars $150 | Midsize SUVs/Trucks $175 | Large SUVs/Trucks/Vans $200",
  prices: ["$150", "$175", "$200"],
  cars: ["Small Cars", "Midsize SUVs/Trucks", "Large SUVs/Trucks/Vans"],
  duration: "Duration: 2-3 hours depending on vehicle size and condition.",
};
...
export const primePackage = {
  ...
  price:
    "Small Cars $225 | Midsize SUVs/Trucks $250 | Large SUVs/Trucks/Vans $275",
  prices: ["$225", "$250", "$275"],
  cars: ["Small Cars", "Midsize SUVs/Trucks", "Large SUVs/Trucks/Vans"],
  duration: "Duration: 3-4 hours depending on vehicle size and condition.",
};
...
export const deluxePackage = {
  ...
  price:
    "Small Cars $350 | Midsize SUVs/Trucks $400 | Large SUVs/Trucks/Vans $450",
  prices: ["$300", "$325", "$350"],

  cars: ["Small Cars", "Midsize SUVs/Trucks", "Large SUVs/Trucks/Vans"],
  duration: "Duration: 4-5 hours depending on vehicle size and condition.",
};
...
export const biWeekly = {
  ...
  package: ["Regular wash", "Basic Detail", "Prime Detail", "Deluxe Detail"],
