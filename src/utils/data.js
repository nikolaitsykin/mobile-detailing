...
export const essentialExteriorServices = [
  "☑️ Multi-Step Pre-Cleaning for Maximum Dirt Removal",
  "☑️ Hand Wash with pH-Balanced Soap for Safe Paint Care",
  "☑️ Detailed Door Jamb Cleaning and Protection",
  "☑️ Gas Cap and Valve Cleaning",
  "☑️ Thorough Wheels Cleaning Using Safe, Effective Brushes",
  "☑️ Tire Shining for a Fresh, Finished Look",
  "☑️ Gentle Drying with Ultra-Soft Towels to Prevent Scratches",
  "☑️ Crystal-Clear Windows Cleaning",
  "☑️ Wax Spray for a Glossy Finish",
  ...
  "☒ Application of Premium Spray Ceramic Coating for Long-Lasting Protection",
];
export const essentialInteriorServices = [
  "☑️ Thorough Cleaning of Door Seals & Jambs",
  "☑️ Comprehensive Vacuuming with Agitation to Reach All Areas",
  "☑️ Effective Surface Cleaning Using Professional-Grade APC",
  "☑️ Detailed Floor Mats Cleaning",
  "☑️ Streak-Free Glass Cleaning",
  "☑️ Fresh Air Freshener Application",
  "☑️ Protective Plastic Dressing for a Clean, Lasting Finish",
...
export const primeExteriorServices = [
  ...
  "☑️ Crystal-Clear Windows Cleaning",
  "☑️ Wax Spray for a Glossy Finish",
  "☑️ Satin Black Tire Dressing for a Sleek, Refined Appearance",
  "☑️ Iron Removal to Protect and Maintain Paint Integrity",
  "☑️ Clay Bar Treatment for a Smooth, Contaminant-Free Surface",
  "☑️ Two-Stage Bug & Tar Removal for a Spotless Exterior",
  "☒ One-Stage Rotary Polish to Restore Shine and Remove Swirls",
  "☒ Application of Premium Spray Ceramic Coating for Long-Lasting Protection",
];
export const primeInteriorServices = [
  ...
  "☑️ Fresh Air Freshener Application",
  "☑️ Protective Plastic Dressing for a Clean, Lasting Finish",
  "☑️ Deep Hot Water Shampoo for Stubborn Stains",
  "☑️ Steam Cleaning for Plastics, Glass, and Leather",
  "☑️ Leather Protection & Conditioning for Long-Lasting Care",
  "☑️ Meticulous Cracks & Crevices Cleaning",
  "☑️ Pet hair/Sand removal",
  "☒ Headliner Cleaning with Enzyme Cleaner for a Spotless Look",
  "☒ Ozone Treatment for Complete Odor Neutralization",
  "☒ Effective Removal of Dirt, Stains, and Harmful Bacteria",
];
...
export const deluxeExteriorServices = [
  ...
  "☑️ Clay Bar Treatment for a Smooth, Contaminant-Free Surface",
  "☑️ Two-Stage Bug & Tar Removal for a Spotless Exterior",
  "☑️ One-Stage Rotary Polish to Restore Shine and Remove Swirls",
  "☒ Application of Premium Spray Ceramic Coating for Long-Lasting Protection",
];
export const deluxeInteriorServices = [
  ...
  "☑️ Leather Protection & Conditioning for Long-Lasting Care",
  "☑️ Meticulous Cracks & Crevices Cleaning",
  "☑️ Headliner Cleaning with Enzyme Cleaner for a Spotless Look",
  "☑️ Ozone Treatment for Complete Odor Neutralization",
  "☑️ Effective Removal of Dirt, Stains, and Harmful Bacteria",
];
