...
const odorRemovalPrices = ["$235", "$260", "$285"];
...
export const threeYearsceramicCoating = {
  ...
  additional: [
    { text: "For a best results we recommend to add Paint Correction with up to $200 off" },
  ],
...
export const ultimateInterior = {
  ...
  interiorServices: [
    { text: "Everything in Express Service:", bold: true },
    ...
    { text: "• Floor mats cleaned & steamed" },
